// CoinTiger_Rest_ExeTest.cpp : 定义控制台应用程序的入口点。
//
...
//using namespace CoinTiger_Market_WebSocketAPI;
//using namespace std;
...
BOOL ExecDosCmd(char *get_websocket)
{
	...
	if (!CreateProcess("D:\\vs2013cpp\\CoinTiger_Rest_ExeTest\\CoinTiger_Rest_ExeTest\\ConsoleApplication.exe", get_websocket
...
//		Sleep(1000);
//	}
	//char szHost[512] = "api.cointiger.pro";
